"""
Poblar la BD con productos variados de Carrefour, organizados por categoría.
...
Uso:
    ...
    python scripts/populate_carrefour_products.py

    # Dry-run (solo consola, sin tocar DB)
    python scripts/populate_carrefour_products.py --dry-run
"""
import sys
import os
...
CATEGORIES = {
    ...
    "Mascotas":              ["alimento perro", "alimento gato", "piedras gato"],
    "Bebés":                 ["pañales", "toallitas humedas"],
...
def main():
    ...
    print("=== Poblando BD con productos de Carrefour ===")
    if dry_run:
