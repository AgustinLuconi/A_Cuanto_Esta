"""
Poblar la BD con productos variados de Supermercados Día, organizados por categoría.
...
Uso:
    ...
    python scripts/populate_dia_products.py

    # Dry-run (solo consola, sin tocar DB)
    python scripts/populate_dia_products.py --dry-run
"""
import sys
import os
...
def main():
    ...
    print("=== Poblando BD con productos de Día ===")
    if dry_run:
