"""
Poblar la BD con productos variados de Jumbo, organizados por categoría.
...
Uso:
    ...
    python scripts/populate_jumbo_products.py

    # Dry-run (solo consola, sin tocar DB)
    python scripts/populate_jumbo_products.py --dry-run
"""
import sys
import os
...
def main():
    ...
    print("=== Poblando BD con productos de Jumbo ===")
    if dry_run:
