"""
Poblar la BD con productos variados de Átomo, organizados por categoría.
...
Uso:
    ...
    python scripts/populate_atomo_products.py

    # Dry-run (solo consola, sin tocar DB)
    python scripts/populate_atomo_products.py --dry-run
"""
import sys
import os
...
def main():
    ...
    print("=== Poblando BD con productos de Átomo ===")
    if dry_run:
