"""
Poblar la BD con productos variados de Vea, organizados por categoría.
...
Uso:
    ...
    python scripts/populate_vea_products.py

    # Dry-run (solo consola, sin tocar DB)
    python scripts/populate_vea_products.py --dry-run
"""
import sys
import os
...
def main():
    ...
    print("=== Poblando BD con productos de Vea ===")
    if dry_run:
