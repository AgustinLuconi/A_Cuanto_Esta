"""
Poblar la BD con productos variados de Chango Más (MasOnline), organizados por categoría.
...
Uso:
    ...
    python scripts/populate_chango_mas_products.py

    # Dry-run (solo consola, sin tocar DB)
    python scripts/populate_chango_mas_products.py --dry-run
"""
import sys
import os
...
def main():
    ...
    print("=== Poblando BD con productos de Chango Más ===")
    if dry_run:
