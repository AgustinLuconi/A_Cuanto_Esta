...
export const CurrentPriceSchema = z.object({
  ...
  original_price: z.coerce.number().nullable().default(null),
...
export const EconomicContextSchema = z.object({
  inflation_monthly: z.coerce.number().nullable().default(null),
  inflation_yearly: z.coerce.number().nullable().default(null),
  dollar_blue: z.coerce.number().nullable().default(null),
  dollar_oficial: z.coerce.number().nullable().default(null),
  dollar_mayorista: z.coerce.number().nullable().default(null),
  dollar_mep: z.coerce.number().nullable().default(null),
  dollar_ccl: z.coerce.number().nullable().default(null),
  dollar_cripto: z.coerce.number().nullable().default(null),
  dollar_tarjeta: z.coerce.number().nullable().default(null),
  uva_index: z.coerce.number().nullable().default(null),
  plazo_fijo_rate: z.coerce.number().nullable().default(null),
  risk_country: z.coerce.number().nullable().default(null),
  last_updated: z.string(),
  inflation_monthly_change: z.coerce.number().nullable().default(null),
  inflation_monthly_date: z.string().nullable().default(null),
  dollar_blue_change: z.coerce.number().nullable().default(null),
  dollar_oficial_change: z.coerce.number().nullable().default(null),
  dollar_mayorista_change: z.coerce.number().nullable().default(null),
  dollar_mep_change: z.coerce.number().nullable().default(null),
  dollar_ccl_change: z.coerce.number().nullable().default(null),
  dollar_cripto_change: z.coerce.number().nullable().default(null),
  dollar_tarjeta_change: z.coerce.number().nullable().default(null),
  risk_country_change: z.coerce.number().nullable().default(null),
  inflation_ytd: z.coerce.number().nullable().default(null),
});
