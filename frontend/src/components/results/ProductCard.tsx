  ...
  return (
    ...
    >
      <Link
        ...
        className="block bg-surface border border-border rounded-xl p-4 hover:shadow-md hover:border-primary/40 transition-all"
      >
        <div className="flex gap-4">
          {/* Imagen */}
          <div className="w-20 h-20 shrink-0 bg-background rounded-lg overflow-hidden flex items-center justify-center border border-border/40">
            {product.image_url ? (
              <Image
          ...
          <div className="flex-1 min-w-0 space-y-1">
            <div className="flex items-start justify-between gap-2">
              ...
              {isCheapest && (
                <span className="shrink-0 px-2 py-0.5 bg-down/10 text-down text-xs font-semibold rounded-full border border-down/20 animate-pulse">
                  MÁS BARATO
                </span>
              )}
            </div>
