...
// ============================================================================
// Logo — wordmark only, locked
// ============================================================================

function Logo({ size = 18, color = "var(--primary)" }) {
  return (
    <div style={{
...
// ============================================================================
// Category icon system — color illustration
//
// Design language:
//   • viewBox 64×64, background circle r=30
//   • Background: very soft tinted off-whites (≈10% saturation)
//   • 2–3 colors per icon + white, flat fills — no gradients inside icons
//   • 0.8–1.2px stroke only where needed for white-on-white definition
//   • No faces, no shine blobs, no anthropomorphic features
//   • Consistent visual area: each product fills ~55–65% of the circle
//   • Uniform shadow treatment: single soft ellipse under each object
// ============================================================================
...
function CatIcon({ id, size = 72 }) {
  const bg = ICON_BG[id] || "#f5f5f5";

  const content = {

    // ── LÁCTEOS: sachet de leche ────────────────────────────────────────────
    lacteos: <>
      {/* shadow */}
    ...
    bebidas: <>
      ...
      {/* body */}
      <path d="M23 22 L41 22 L41 52 a2 2 0 0 1 -2 2 L25 54 a2 2 0 0 1 -2 -2 Z"
        fill="#6240a8"/>
      {/* label */}
    ...
    panificados: <>
      ...
      {/* bread body */}
      <path d="M12 38 a20 16 0 0 1 40 0 L52 46 a2 2 0 0 1 -2 2 L14 48 a2 2 0 0 1 -2 -2 Z"
        fill="#c08a3a"/>
      {/* base shadow band */}
    ...
    limpieza: <>
      ...
      {/* bottle body */}
      <path d="M20 21 L36 21 L37 52 a2 2 0 0 1 -2 2 L22 54 a2 2 0 0 1 -2 -2 Z"
        fill="#2a8a8a"/>
      {/* label */}
    ...
    higiene: <>
      ...
      {/* bottle body */}
      <path d="M19 22 L45 22 L46 50 a2 2 0 0 1 -2 2 L20 52 a2 2 0 0 1 -2 -2 Z"
        fill="#c05880"/>
      {/* label */}
    ...
    frutas: <>
      ...
      {/* leaf */}
      <path d="M33 15 c-1 -0.5 -6 0.5 -5.5 3.5 c0 2 4 2.5 6.5 1 c1 -1 0.5 -3 -1 -4.5 z"
        fill="#4a9a58"/>
      {/* apple body */}
      <path d="M18 34 c0 -9 5.5 -15 11 -15 c2.5 0 4 1.5 3 3 c-1 -1.5 1.5 -3 4 -3 c5.5 0 11 6 11 15 c0 9 -6 16 -14 16 c-8 0 -15 -7 -15 -16 z"
        fill="#3a8a4a"/>
      {/* subtle highlight */}
      <path d="M23 27 c0 -1.5 2 -3 5 -2 c0.5 3 -0.5 6 -3.5 6 c-1.5 -1 -1.5 -2 -1.5 -4 z"
        fill="white" opacity="0.22"/>
    </>,

    // ── CONGELADOS: copo de nieve ────────────────────────────────────────────
    congelados: <>
    ...
    snacks: <>
      ...
      <path d="M18 15 q-1.5 -3 0.5 -3 q1 -2 2.5 0 q1 -2 2.5 0 q1 -2 3 0 q1 -2 3 0 q1 -2 3 0 q1 -2 3 0 q1 -2 3 0 q1 -2 2.5 0 q1.5 -2 0.5 3 z"
        fill="#b55e18"/>
      {/* bag body */}
      <path d="M18 14 L46 14 L44 52 a2 2 0 0 1 -2 2 L22 54 a2 2 0 0 1 -2 -2 Z"
        fill="#d07828"/>
      {/* label band */}
...
Object.assign(window, { Logo, CatIcon });
